...
# Load functions
Rcpp::sourceCpp('code/core_zinb_x3.cpp');   # The MCMC algorithm of fitting a zero-inflated negative binomial (ZINB) model written in C++
Rcpp::sourceCpp('code/core_dm_x3.cpp');   # The MCMC algorithm of fitting a Dirichlet-multinomial (DM) model written in C++
source('code/functions_xiaowei.R');   # Other related functions written in R
# ============================================================================================
...
otu <- otu_list[["TettAJ_2016"]];   # Abundance table at all taxonomic levels
...
R <- zinb_model_estimator(Y, z, s_1, iter, TRUE, 0, S, aggregate, TRUE, B, b_0);
end_time <- proc.time();
...
# Run MCMC
start_time <- proc.time();
R <- dm_model_estimator(Y, z, iter, S, aggregate, TRUE, B, b_0);
end_time <- proc.time();
time <- end_time - start_time;
# ============================================================================================
